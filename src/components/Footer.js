...
const Footer = () =>
    <div className=''>
        <footer className="bg-gray-100 relative bottom-0">
            ...
            <div className="py-6 px-4 bg-gray-200 md:flex md:items-center md:justify-between">
                <span className="text-sm text-gray-800 sm:text-center">© 2022 <a href="https://flowbite.com">Flowbite™</a>. All Rights Reserved.
                </span>
