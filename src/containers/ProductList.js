...
import { addToCart } from '../stores/user';
        ...
        <div className='group flex flex-col bg-white rounded-md border h-full hover:shadow-lg hover:drop-shadow-xl hover:border-gray-50 cursor-pointer p-2'>
            ...
            <div className='h-1/2 flex flex-col relative'>
                ...
                <div className='hidden group-hover:block'>
                    <button {...loading ? { disabled: true } : { disabled: false }} onClick={() => dispatch(addToCart(addCart(id, name, image, price, 1)))} className='bg-orange-500 ease-out hover:bg-orange-700 mb-4 ml-1 text-sm absolute bottom-0 w-[calc(100%-10px)] rounded-md text-white py-2 px-4'>
